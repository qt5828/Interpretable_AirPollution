...
def train(sampleLoader, val_loader, model, model_name, SELECTED_COLUMN, mask=False, LUR=False, l1=False, l2=False):
    ...
    for epoch in range(1, n_epochs + 1):
        ...
        if eval_mse < best_mse:
            ...
            best_mse = eval_mse
            mape = eval_mape
            torch.save(best_model.state_dict(), "./save_KCC_ours/"+SELECTED_COLUMN+"/"+model_name+"_{}.pth".format(SEQ_LENGTH))
...
if __name__ == '__main__':
    ...
    for SELECTED_COLUMN in ["median_no2"]:  # ["median_pm25", "median_so2", "median_pm10", "median_no2", "median_co", "median_o3"]
        ...
        sampleLoader = DataLoader(train_data, 1024, shuffle=True, num_workers=4, worker_init_fn=seed_worker, generator=g)
    ...
    # for SELECTED_COLUMN in ["median_pm25","median_pm10","median_no2"]: # "median_pm25","median_pm10",
